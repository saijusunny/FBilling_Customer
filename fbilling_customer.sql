...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2022 at 04:14 AM
...
(10, ' Infox Technologies', 'Infopark Phase-1\nkochi\nph:56789098\n\n\n\n\n\n\n\n\n\n\n\n', '', '456789847898987', '', 'kn', 'before amount', '', 'kn8347.26', 'dd.mm.yyyy', '2022-06-20', '3', 'Screenshot (442).png', 0, 'tax 1', 12.5, 0, 'tax 2', 6, 0, NULL, '', 0, 0, 0, 0, 0, 0, 'EST', 'Maroon', 'Estimate     est', 'Professional 1 (logo on left side)', 'Estimate#   est', 'Estimate date   8/9/2022', 'Due date   8/10/2022', 'Estimate to   customer', 'Estimate total   700', 3, 'conditions\n\n\n\n\n\n\n\n\n\n\n\n\n\n', 'Professional 1 (logo on left side)', 'P.ORD', '5', 0, 'Purchase Order', 'P.Order#', 'P.Order Date', 'Due date', 'Vendor', 'Delivery to', 'P.Order total', 'terms and conditions\n\n\n\n\n\n\n\n\n\n\n\n\n\n', 'Purchase Order E-Mail template', '{{Customer_Email}}{{Customer_Email}}{{Customer_Address}}{{Customer_Address}}{{Company_Email1}}{{Company_Email1}}\n\n\n\n\n\n\n\n\n\n');
...
(1, NULL, 'Cust', NULL, 'Customer1', 'rteett', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '004', 0, 0),
...
(15482, NULL, 'Default', '1', 'Customer2', 'errors', 'dfdfd', 'dfdffd', 'viswam', 'viswam@gmail.com', '111444', '144114', '1141414111', 'sfdf', 'sdfdf', '145', '5545', '', 0, 4, 'America', 'ekm', 'Both(Client/Vender)', 'cfgffggfdgf\n\n', '588', 0, 0),
(15515, NULL, 'Default', '1', 'fddfh', 'sdfs', 'fdgfd', 'fdgfd', 'sdfd', 'sdfs', '44', '451', NULL, 'dfg', 'fdgfd', '1452', '1452', '1', 2, 2, 'America', 'cxcvc', NULL, NULL, '45774', 0, 0),
(15530, NULL, 'Default', '1', 'bvnvn', 'bnbvnbvbv', '', '', 'bnbvn', 'bnb@gmail.com', '', '', 'None', '', '', '', '', '', 0, 0, '', '', 'Both(Client/Vender)', 'None\n', '1458', 4, 0),
(15531, NULL, 'Default', '', 'dfsdsfd', 'rteett', '', '', '', '', '', '', NULL, '', '', '', '', '', 0, 0, '', '', NULL, NULL, '4457', 0, 0),
(15540, NULL, 'Default', '1', 'Customer2fdsfd', 'errorssd', 'dfdfd', 'dfdffd', 'viswam', 'viswam@gmail.com', '111444', '144114', NULL, 'sfdf', 'sdfdf', '145', '5545', '1', 4, 4, 'America', 'ekm', NULL, NULL, '14745', 0, 0),
(15541, NULL, 'Default', '1', 'Elnixdfd', 'elnix eruveli', 'Elnix Power Zone', 'Elnix Power Zone cho', 'joby', 'joby@gmail.com', '1234567895', '+1 (212) 222 8888', 'None', 'joby joseph', 'jobyjoseph@gmail.com', '1234567895', '+1 (212) 222 8888', '1', 12, 12, 'America', 'chott', 'Vender', 'None\n', '245414', 12, 0),
(15542, NULL, 'Default', '1', 'bvnvndfd', 'bnbvnbvbv', '', '', 'ghhjg', 'bnb@gmail.com', '', '', 'None', '', '', '', '', '1', 0, 0, '', '', 'Both(Client/Vender)', 'None\n', '145854', 0, 0),
...
--
ALTER TABLE `customer`
  MODIFY `customerid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15553;
